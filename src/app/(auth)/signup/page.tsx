    ...
    <main className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold text-white">Start for free</h1>
          <p className="text-sm text-white/40 mt-1">10,000 pageviews/month. Forever.</p>
        </div>
        <form onSubmit={handleSignup} className="bg-[#111118] border border-white/8 rounded-2xl p-6 space-y-4">
